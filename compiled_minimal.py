...
def load_and_preprocess_data():
    ...
    if target_col_actual is None:
        raise ValueError(
            f"Target column 'y' not found (case-insensitive). "
...
def train_model(model, X_train, y_train, X_test, y_test):
    ...
    model_checkpoint_path = "models/simplemodel_best.keras"
...
def main():
    ...
    import os
    os.makedirs("models", exist_ok=True)
    model_path = "models/simplemodel_final.keras"
    model.save(model_path)
    print(f"\n[INFO] Model saved to: {model_path}")
    print("[INFO] Best model saved to: models/simplemodel_best.keras")
